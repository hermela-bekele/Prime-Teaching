...
export default function DepartmentHeadTeacherProgressPage() {
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-4xl font-bold tracking-tight text-slate-900">Teacher Progress</h1>
        <p className="mt-1 text-sm text-slate-500">Detailed per-teacher progress, filters, and date ranges.</p>
      </div>
